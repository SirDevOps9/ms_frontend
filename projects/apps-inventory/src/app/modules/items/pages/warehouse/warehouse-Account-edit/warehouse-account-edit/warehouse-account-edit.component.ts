...
@Component({
  selector: 'app-warehouse-account-edit',
  templateUrl: './warehouse-account-edit.component.html',
  styleUrl: './warehouse-account-edit.component.scss'
})
export class WarehouseAccountEditComponent {
  glAccountLookup = []
  CashSalesLookup = []
