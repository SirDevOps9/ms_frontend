...
import { environment } from 'projects/adminportal/src/environments/environment';

const LAYOUT_CONFIG_LOCAL_STORAGE_KEY = `${environment.Version}-layoutConfig`;
const BASE_LAYOUT_TYPE_LOCAL_STORAGE_KEY = `${environment.Version}-baseLayoutType`;
