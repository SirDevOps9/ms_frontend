...
import { Actions, PermissionTreeNode, RouteFilter } from '../models';
...
export class HasPermissionDirective {
  @Input() set appHasPermission(routerFilter: RouteFilter) {
    console.log('Directive', routerFilter);
    if (this.authService.hasPermission(routerFilter)) {
