...
@Component({
  selector: 'app-sales-invoice-tracking-component',
  templateUrl: './sales-invoice-tracking-component.component.html',
  styleUrl: './sales-invoice-tracking-component.component.scss'
})
export class SalesInvoiceTrackingComponentComponent implements OnInit {
  configData: any = {};
