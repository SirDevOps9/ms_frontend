...
@Component({
  selector: 'app-customer-opening-balance-no-children',
  templateUrl: './customer-opening-balance-no-children.component.html',
  styleUrl: './customer-opening-balance-no-children.component.scss'
})
export class CustomerOpeningBalanceNoChildrenComponent implements OnInit {
