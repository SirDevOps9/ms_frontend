...
import { AddCustomerCategoryDto, AddCustomerDefinitionDto, CustomerCategoryDto , EditCustomerCategoryDto, EditCustomerDefintionsDto } from './models';
import { CategoryDropdownDto, CityDto, CountryDto, CurrencyDto, TagDropDownDto } from '../general-setting/models';
...
export class SalesProxyService {
 ...
 EditCustomerCategory(EditCustomerCategoryDto: EditCustomerCategoryDto): Observable<EditCustomerCategoryDto> {
  return this.httpService.put<EditCustomerCategoryDto>(`CustomerCategory`,EditCustomerCategoryDto);
}
