...
import { LoaderService, LanguageService, ToasterService, RouterService, PageInfoResult, PageInfo } from 'shared-lib';
import { AddCustomerCategoryDto, AddCustomerDefinitionDto, CityDto, CountryDto, CurrencyDto, CustomerCategoryDto, EditCustomerCategoryDto, EditCustomerDefintionsDto } from './models';
...
export class SalesService {
  ...
  private customerCategoryDataByID = new BehaviorSubject<EditCustomerCategoryDto>({} as EditCustomerCategoryDto);
  ...
  constructor(  private loaderService: LoaderService,
    ...
    private routerService: RouterService , private salesProxy : SalesProxyService) { }
  ...
  getCustomerCategoryByID(id : number) {
    this.salesProxy.getCustomerCategoryByID(id)
    .subscribe(res=>{
      if(res) {
  ...
  getChildrenAccountsDropDown() {
    this.salesProxy.getChildrenAccountsDropDown()
    .subscribe(res=>{
      if(res) {
  ...
  getpriceListDropDown() {
    this.salesProxy.getpriceListDropDown()
    .subscribe(res=>{
      if(res) {
  ...
  getpaymentTermsListDropDown() {
    this.salesProxy.getpaymentTermsListDropDown()
    .subscribe(res=>{
      if(res) {
  ...
  getCustomerCategoryDropdown() {
    this.salesProxy.getCustomerCategoryDropdown()
    .subscribe(res=>{
      if(res) {
